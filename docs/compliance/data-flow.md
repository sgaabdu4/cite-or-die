...
5. Only retrieved chunks are sent to the configured provider; hosted-provider context must pass entity-placeholder and residual-entity checks first.
...
10. Audit events store allowlisted metadata and hash-chain integrity fields.
